...
<main class="login-shell">
    ...
    <section class="login-panel">
        <form method="post" class="login-card">
            ...
            <?php if ($loginFlash): ?><div class="login-notice <?= e($loginFlash['type']??'info') ?>"><i class="bi <?= ($loginFlash['type']??'')==='success'?'bi-check-circle':((($loginFlash['type']??'')==='error')?'bi-exclamation-circle':'bi-info-circle') ?>"></i><span><?= e($loginFlash['message']??'') ?></span></div><?php endif; ?>
            ...
            <div class="form-row"><label class="check"><input type="checkbox" name="remember"> Lembrar de mim</label><a href="<?= url('recuperar-senha') ?>">Esqueci minha senha</a></div>
